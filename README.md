...
buildscript {
    dependencies {
        classpath 'io.screenshotbot.screenshot-tests-for-android:plugin:0.20.0'
    }
}
```
...
dependencies {
    androidTestImplementation 'io.screenshotbot.screenshot-tests-for-android:core:0.20.0'
}
```
